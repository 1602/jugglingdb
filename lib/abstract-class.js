 ...
 * Module dependencies
 */
 define(['util', './jutil', './validatable', './list', './hookable']
  , function(util, jutil, validatable, List, hookable) {

var exports = {};
var Validatable = validatable.Validatable;
var Hookable = hookable.Hookable;
