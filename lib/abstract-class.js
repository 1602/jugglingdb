 ...
 */
AbstractClass.create = async(function (data, callback) {
 ...
 * Update or insert
 */
AbstractClass.upsert = AbstractClass.updateOrCreate = async(function upsert(data, callback) {
    if (stillConnecting(this.schema, this, arguments)) return;
 ...
 */
AbstractClass.exists = async(function exists(id, cb) {
    if (stillConnecting(this.schema, this, arguments)) return;
 ...
 */
AbstractClass.find = async(function find(id, cb) {
    if (stillConnecting(this.schema, this, arguments)) return;
 ...
 * - Array of instances
 */
AbstractClass.all = async(function all(params, cb) {
    if (stillConnecting(this.schema, this, arguments)) return;
 ...
 * @param {Function} cb - callback called with (err, instance)
 */
AbstractClass.findOne = async(function findOne(params, cb) {
    if (stillConnecting(this.schema, this, arguments)) return;
 ...
 */
AbstractClass.destroyAll = async(function destroyAll(cb) {
    if (stillConnecting(this.schema, this, arguments)) return;
 ...
 */
AbstractClass.count = async(function (where, cb) {
    if (stillConnecting(this.schema, this, arguments)) return;
 ...
 * @param callback(err, obj)
 */
AbstractClass.prototype.save = async(function (options, callback) {
 ...
 */
AbstractClass.prototype.destroy = async(function (cb) {
    if (stillConnecting(this.constructor.schema, this, arguments)) return;
 ...
 */
AbstractClass.prototype.updateAttribute = async(function updateAttribute(name, value, callback) {
    var data = {};
    data[name] = value;
 ...
 * @param {Function} callback - callback called with (err, instance)
 */
AbstractClass.prototype.updateAttributes = async(function updateAttributes(data, cb) {
    if (stillConnecting(this.constructor.schema, this, arguments)) return;
 ...
 */
AbstractClass.prototype.reload = async(function reload(callback) {
    if (stillConnecting(this.constructor.schema, this, arguments)) return;
...
AbstractClass.hasMany = function hasMany(anotherClass, params) {
    ...
    var destroy = async(function (id, cb) {
...
function defineScope(cls, targetClass, name, params, methods) {
    ...
    Object.defineProperty(cls, name, {
        ...
        get: function () {
            var f = async(function (cond, cb) {
                ...
                return targetClass.all(mergeParams(actualCond, f._scope), cb);
            });
    ...
    var create = async(function create(data, cb) {
        if (typeof data === 'function') {
            cb = data;
            data = {};
        }
    ...
    var destroyAll = async(function (id, cb) {
        // implement me
    });
