...
function AbstractClass(data) {
    ...
    Object.defineProperty(this, '_dirtyStates', {
        writable: true,
        enumerable: false,
        configurable: true,
        value: {}
...
function mergeNonDirty(obj, data){
    Object.getOwnPropertyNames(obj._dirtyStates).forEach( function(p){
      data[p] = obj[p];
    });
}
