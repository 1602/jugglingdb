            ...
            passports.forEach(function(p) {
                ...
                if (!p.ownerId) {
                    ...
                    user.__cachedRelations.posts.forEach(function(pp) {
                        ...
                        pp.title.indexOf('Post').should.equal(0);
                    });
                }
            });
            done();
        ...
        Passport.all({
            ...
            passports.forEach(function(p) {
                ...
                if (!p.ownerId) {
                    ...
                    user.__cachedRelations.posts.forEach(function(pp) {
                        pp.userId.should.equal(user.id);
                        pp.title.indexOf('Article').should.equal(0);
        ...
        User.all({
            ...
            users.forEach(function(user) {
                ...
                user.__cachedRelations.posts.forEach(function(p) {
                    ...
                    p.title.indexOf('Post').should.equal(0);
                });
        ...
        function createPosts() {
            clearAndCreate(
                ...
                [
                    ...
                    {title: 'Article C', userId: createdUsers[0].id},
